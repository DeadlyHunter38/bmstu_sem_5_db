...
class Animals():
    ...
    def __init__(self, id:int, animal_name:str, kind:str, age:int, id_vet:int, id_diagnosis:int, id_treatment:int):
        self.id = id
    ...
    def get(self):
        return {'id': self.id, 'animal_name': self.animal_name, 'kind': self.kind,
                'age': self.age, 'id_vet': self.id_vet, 'id_diagnosis': self.id_diagnosis,
