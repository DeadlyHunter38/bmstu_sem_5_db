...
def do_task_1():
    output_task_1()
    animals = Enumerable(import_animals('C:/msys64/home/Лев/bmstu_sem_5_db/lab_07/code/data/animals.csv'))
    veterinarians = Enumerable(import_vets('C:/msys64/home/Лев/bmstu_sem_5_db/lab_07/code/data/veterinarians.csv'))
